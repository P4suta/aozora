...
//! ```
//!
//! The lexer's classify-stage recogniser (`crate::pipeline::lexer::classify::recognize_gaiji`)
...
/// Pure-function lookup used by the lex pipeline's classify stage
...
// from `crates/aozora/data/aozora-gaiji-chuki.tsv` (the
...
// `crate::encoding::jisx0213_table::DESCRIPTION_TO_CHAR` (alias-imported at
