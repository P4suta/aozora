...
//! [`crate::scan`] module and exposes a stateful iterator yielding one
...
//! ## Algorithm
//!
//! 1. [`crate::scan::scan_offsets`] returns the byte offsets of every
...
//! [`crate::scan`] for the full backend selection. The previous naive
