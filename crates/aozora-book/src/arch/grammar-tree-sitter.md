...
The Rust parser is a pipeline (sanitize → tokenize → pair → classify)
with a hand-rolled classifier; reading it tells you *how* the
canonical implementation works but not *what* the spec accepts. A
