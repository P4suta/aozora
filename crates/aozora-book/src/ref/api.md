...
[`docs.rs/aozora`](https://docs.rs/aozora/latest/aozora/) hosts the released API
...
| `/aozora/api/aozora_pipeline/` | lexer (sanitize → tokenize → pair → classify) + `lex` orchestrator |
