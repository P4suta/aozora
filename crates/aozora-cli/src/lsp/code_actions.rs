...
use crate::lsp::diagnostics::{DiagnosticPayload, SerializablePairKind};
...
pub(super) fn wrap_selection_actions(
    source: &str,
...
/// `data` payload (set by `crate::lsp::diagnostics::describe`, private) describing
