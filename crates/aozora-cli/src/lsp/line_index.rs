...
//! ## Why this exists
//!
//! [`crate::lsp::position::byte_offset_to_position`] is `O(byte_offset)`
...
impl LineIndex {
    ...
    #[must_use]
    pub(super) fn position(&self, source: &str, byte_offset: usize) -> Position {
    ...
    #[must_use]
    pub(super) fn byte_offset(&self, source: &str, position: Position) -> Option<usize> {
